...
export default function GenderScreen() {
  ...
  const params = useLocalSearchParams<{ displayName: string; birthDate: string }>();
      ...
      <View style={styles.content}>
        ...
        <View style={styles.options}>
          {GENDERS.map((g) => (
            ...
            >
              <Text style={[styles.optionText, selected === g.value && styles.optionTextSelected]}>
                {g.label}
              </Text>
            </TouchableOpacity>
          ))}
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '700', color: '#333', marginBottom: 24 },
